...
path = "auditoria_causalidad_checkpoint_10A_10B_10C.md"
content = """# AUDITORÍA DE CAUSALIDAD — CHECKPOINT 10A → 10B → 10C
...
*(Y otros específicos de 10A/10B confinados a `boards` o pasados en el checkpoint anterior).*
...
- `yarn vitest run excalidraw-app/tests/boards`: Aprobado (180/180). Evalúa el encapsulamiento funcional del Scope 10A-10C.
Los QG globales introducen ruido irrelevante para certificar los alcances arquitectónicos de persistencia y reconciliación solicitados.
