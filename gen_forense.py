...
path = 'diagnostico_forense.md'
with open(path, 'w', encoding='utf-8') as f:
    f.write("""# Diagnóstico Forense - Bug Rename
...
El problema real radica en que el `blur` sobre el input tiene un significado ambiguo:
A) "El usuario hizo click en otra parte" (Confirmar edición)
B) "Excalidraw robó el foco mediante `focusContainer()` en medio del flujo de vida de la UI" (Falso positivo)
