# Auditoría y Plan Técnico — FASE 10 (Hardening)
...
- **Persistencia Actual (`LocalStorageBoardRepository`):**
  ...
  - **Déficit Multi-Tab:** No existe coordinación real entre pestañas (no se usa `tabSync.ts` para el grafo). Si dos pestañas guardan, es un _last-write-wins_ a ciegas que puede sobrescribir ramas del grafo.
